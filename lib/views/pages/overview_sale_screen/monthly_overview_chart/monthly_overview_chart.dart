...
class MonthlyOverviewChart extends StatefulWidget {
  const MonthlyOverviewChart({Key key}) : super(key: key);
...
class _MonthlyOverviewChartState extends State<MonthlyOverviewChart> {
  @override
        ...
        children: [
          Container(
            ...
            child: charts.BarChart(
              MonthlyOverviewChart._createYearDataChart(),
              animate: true,
