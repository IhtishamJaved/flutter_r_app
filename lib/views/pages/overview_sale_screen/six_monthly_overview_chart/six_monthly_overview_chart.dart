...
import '../daily_overview_chat/component/daily_overview_container.dart';
import '../daily_overview_chat/component/daily_overview_table.dart';

class SixMonthlyOverviewChart extends StatefulWidget {
  const SixMonthlyOverviewChart({Key key}) : super(key: key);

  static List<charts.Series<BarMmodel, String>> _createYearDataChart() {
    final data = [
      BarMmodel("July 2020", 20),
      BarMmodel("Dec 2020", 23),
      BarMmodel("July 2021", 29),
      BarMmodel("Dec 2021", 30),
      BarMmodel("July 2022", 29),
    ];
    return [
  ...
  @override
  State<SixMonthlyOverviewChart> createState() =>
      _SixMonthlyOverviewChartState();
}
...
class _SixMonthlyOverviewChartState extends State<SixMonthlyOverviewChart> {
  @override
        ...
        children: [
          Container(
            ...
            child: charts.BarChart(
              SixMonthlyOverviewChart._createYearDataChart(),
              animate: true,
